  ...
  return (
    <main className="login">
      <div className="login__card1">
        <div className="login__card1__logo">
          <Image
          src={Logo}
          width={36}
          height={36}
        ...
        <h1 className="login__card1__title">
          Sign in or <span>Create an account</span>
        </h1>

        <form className="login__card1__form">
          <input
            type="text"
            className="login__card1__form__input"
            placeholder="Email"
          />
          <input
            type="text"
          ...
          <div className="login__card1__form__remeber">
            <h2>Remember Info</h2>
            <Switch />
          </div>

          <button className="login__card1__form__button">Login</button>

          <h3 className="login__card1__form__login">Forgotten password?</h3>
          <div className="login__card1__form__continue">
            <svg
              width="102"
              height="4"
              viewBox="0 0 102 4"
            ...
            >
              <path
                d="M0.666667 2C0.666667 2.73638 1.26362 3.33333 2 3.33333C2.73638 3.33333 3.33333 2.73638 3.33333 2C3.33333 1.26362 2.73638 0.666667 2 0.666667C1.26362 0.666667 0.666667 1.26362 0.666667 2ZM2 2.25L102 2.25001L102 1.75001L2 1.75L2 2.25Z"
                fill="#4A576F"
                fillOpacity="0.7"
              />
            </svg>
            ...
            >
              <path
                d="M102.667 1.99999C102.667 2.73637 103.264 3.33332 104 3.33332C104.736 3.33332 105.333 2.73637 105.333 1.99999C105.333 1.26361 104.736 0.666657 104 0.666658C103.264 0.666658 102.667 1.26361 102.667 1.99999ZM2.18557e-08 2.25L104 2.24999L104 1.74999L-2.18557e-08 1.75L2.18557e-08 2.25Z"
                fill="#4A576F"
                fillOpacity="0.7"
              />
            </svg>
          ...
          <div className="login__card1__form__option">
...
Facebook
      ...
      <div className="login__card2">
        <div className="login__card2__carousel">
          <h2 className="login__card2__carousel__title">
            Experiencing the World of Art with <span>Galadio</span>
          </h2>
          <h3 className="login__card2__carousel__subtitle">
            Encouraging New and Emerging Arttist
          </h3>

          <div className="login__card2__carousel__nav-group">
            <svg
              width="40"
              height="40"
              viewBox="0 0 40 40"
