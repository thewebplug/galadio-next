  ...
  return (
    <main className="profile">
      <div className="profile__header">
        <Image src={Bg} objectFit="cover" layout="fill" alt="" />
      ...
      <div className="profile__user">
        <Image src={Image4} width={181} height={181} alt="" />
        ...
        <button>
          ...
          >
            <path
              d="M2.7 1.7002H14.3C15.0975 1.7002 15.75 2.3527 15.75 3.1502V11.8502C15.75 12.6477 15.0975 13.3002 14.3 13.3002H2.7C1.9025 13.3002 1.25 12.6477 1.25 11.8502V3.1502C1.25 2.3527 1.9025 1.7002 2.7 1.7002Z"
              stroke="#374957"
              strokeWidth="1.5"
              strokeLinecap="round"
            ...
            />
            <path
              d="M15.75 3.15039L8.5 8.22539L1.25 3.15039"
              stroke="#374957"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      <div className="profile__art">
        <div className="profile__art__title">My Art</div>
